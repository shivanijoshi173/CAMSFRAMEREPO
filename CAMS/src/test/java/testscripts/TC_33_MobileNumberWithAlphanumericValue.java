...
public class TC_33_MobileNumberWithAlphanumericValue extends BaseClass
{
	@Test
	public void MobileNumberWithAlphanumericValueTest() throws Throwable
	{
		
		ExcelUtility ex=new ExcelUtility();
		String mobile = ex.getexceldatainstring("Sheet1", 6, 4);
