...
public class TC_09_FirstNameWithAllLettersInLowerCase extends BaseClass {
	@Test
	public void FirstNameWithAllLettersInLowerCaseTest() throws Throwable {
		ExcelUtility ex=new ExcelUtility();
		String name=ex.getExcelData("Sheet1",8 , 0);
		String accdata=name;
