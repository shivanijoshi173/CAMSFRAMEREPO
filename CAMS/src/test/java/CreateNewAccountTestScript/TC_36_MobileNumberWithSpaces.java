...
public class TC_36_MobileNumberWithSpaces  extends BaseClass
{
	@Test
	public void MobileNumberWithSpacesTest() throws Throwable
	{
		ExcelUtility ex=new ExcelUtility();
		String mobile = ex.getexceldatainstring("Sheet1", 9, 4);
