...
public class TC_32_MobileNumberWith9Digit extends BaseClass
{
	@Test
	public void MobileNumberWith9DigitTest() throws Throwable
	{
		
		ExcelUtility ex=new ExcelUtility();
		String mobile = ex.getexceldatainstring("Sheet1", 5, 4);
