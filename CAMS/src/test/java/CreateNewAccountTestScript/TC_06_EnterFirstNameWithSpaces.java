...
public class TC_06_EnterFirstNameWithSpaces extends BaseClass{
	@Test
	   public void EnterFirstNameWithSpacesTest() throws Throwable 
	{
		ExcelUtility ex=new ExcelUtility();
		String name=ex.getExcelData("Sheet1", 5, 0);
		String accdata=name;
